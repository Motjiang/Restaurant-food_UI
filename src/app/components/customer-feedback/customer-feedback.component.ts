    ...
    <section class="section__container client__container" id="client">
      ...
      <div class="client__content">
        ...
        <p class="section__description">
          "The Food is absolutely remarkable! Their menu offers an incredible
          variety of delicious dishes, catering to all tastes. What truly makes
          The Food stand out is their top-notch service. Their delivery is
          exceptionally quick, ensuring your meal arrives fresh and piping hot."
        </p>
